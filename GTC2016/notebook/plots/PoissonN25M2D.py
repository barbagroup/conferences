'''
Nx = 5000, Ny = 5000, 2D Poisson Benchamrks
'''
...
Hypre = numpy.array([7.310595, 4.038355, 2.074181, 1.077093])

nGPU = numpy.array([4, 8, 16, 32])
AmgX = numpy.array([1.469095, 0.865546, 0.55356, 0.820063])

nTheo = numpy.array([2])
AmgXTheo = numpy.array([1.839657])
...
# config the figure
ax.set_title("2D Poisson, 25M Unknowns", fontsize=22)
...
pyplot.tight_layout()
pyplot.savefig("Poisson_N25M2D.png")
