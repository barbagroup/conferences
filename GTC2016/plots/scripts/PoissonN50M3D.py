'''
Nx = 500, Ny = 500, Nx = 200, 3D Poisson Benchamrks
'''
...
Hypre = numpy.array([29.284282, 14.674587, 7.423235, 4.554032])

nGPU = numpy.array([32])
AmgX = numpy.array([1.408841])
...
# config the figure
ax.set_title("3D Poisson, 50M Unknowns", fontsize=22)
...
pyplot.tight_layout()
pyplot.savefig("Poisson_N50M3D.png")
